...
/* Export */
//1 - The top level of a scene in Model I/O is an MDLAssest You can add child objects such as meshes, cameras and lights to the asset and build up a complete scene hierarchy
let asset = MDLAsset()
asset.add(mdlMesh)
...
//3 -- export the code to the diretory stored in Shared Playground Data
do {
